...
from .views import products_view, shop_view, products_page_view, cart_view, cart_add_view, cart_del_json_view, \
    coupon_check_view, delivery_estimate_view, cart_buy_now_view, cart_del_html_view
...
urlpatterns = [
    ...
    path('cart/del/<str:id_product>/', cart_del_json_view),
    ...
    path('cart/remove/<str:id_product>', cart_del_html_view, name="remove_now"),
]